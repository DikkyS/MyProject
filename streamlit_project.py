# pada program akan ada beberapa ML algorithms yang dibuat dengan datasets di scikit-learn
...
# Judul Project
st.title("MyProject Streamlit using Kaggle Datasets")
...
# Kemudian pilih algorithm
# Akan ditampilkan pada sidebar
...
# Kemudian pilih regressor or classifier
# Akan ditampilkan pada sidebar
...
# Gunakan fungsi load_dataset_name 
